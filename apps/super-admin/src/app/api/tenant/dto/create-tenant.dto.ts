...
import { TenantStatus } from '@lms-backend/libs';
...
export class CreateTenantDto {
  ...
  @ApiProperty({
    type: CreateAdminDto,
    description: 'Admin user to be created alongside the tenant',
  })
  @ValidateNested()
  @Type(() => CreateAdminDto)
...
export class UpdateStatusDto {
  ...
  @IsEnum(TenantStatus, { message: 'name must be a valid TenantStatus' })
  status: TenantStatus;
}